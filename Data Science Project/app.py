...
dataset_option = st.sidebar.selectbox("Choose a dataset:", ["Dataset 1: master-6.csv", "Dataset 2: addiction.csv"])


if dataset_option == "Dataset 1: master-6.csv":
    # Load data
    data = pd.read_csv("../master-6-for-visualization.csv")
    dataset_name = "master-6.csv"
...
if show_dataset == "Dataset 1":
    ...
    if viz_mode == "Static Visualizations":
        ...
        # Place any subset of your Dataset 1 visualizations here (bar charts, line plots, etc.)
        # e.g. plot gender distribution, anxiety scores, etc.
    ...
    if viz_mode == "Static Visualizations":
        ...
        # Addiction filter: 0 = No, 1 = Yes
        addiction_map2 = {0: "No", 1: "Yes"}
        # Map the values in the "addicted" column to their corresponding labels
        data["addicted"] = data["addicted"].map(addiction_map2)


        # Get the unique values in the "addicted" column
        addiction_options2 = list(addiction_map2.values())
